...
const AdminEditProduct = ({ onclose,productData,fetchdata}) => {
  ...
  return (
    <div className='fixed w-full h-full  bg-slate-200 bg-opacity-80 top-0 right-0 bottom-0 left-0 flex justify-center items-center'>
...
<textarea className='h-28 bg-slate-100 border resize-none p-1' placeholder='Enter Product Description' onChange={handleOnChange} name='description' value={data.description} rows={3}>
         ...
         <button className='px-3 py-2 bg-red-600 text-white mb-10 hover:bg-red-700'> Save product Change</button>
